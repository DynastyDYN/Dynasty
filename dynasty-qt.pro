...
greaterThan(QT_MAJOR_VERSION, 4) {
    QT += widgets
    DEFINES += QT_DISABLE_DEPRECATED_BEFORE=0x40800
}
...
DYN_TARGETDEPS += $$PWD/src/leveldb/libleveldb.a
...
!win32|contains(USE_BUILD_INFO, 1) {
    ...
    DYN_TARGETDEPS += $$OUT_PWD/build/build.h
...
macx:ICON = src/qt/res/icons/dynasty.icns
